...
//             Revolutionizing farming with AI-powered solutions, sustainable practices, and modern technology
//           </p>
...
//               <div className="w-8 h-8 bg-green-400 rounded-full mx-auto mb-2 flex items-center justify-center text-white font-bold">👥</div>
//               <div className="text-2xl font-bold text-white">50K+</div>
//               <div className="text-white/70 text-sm">Farmers</div>
//             </div>
//             <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
//               <div className="w-8 h-8 bg-yellow-400 rounded-full mx-auto mb-2 flex items-center justify-center text-white font-bold">🌾</div>
//               <div className="text-2xl font-bold text-white">500+</div>
//               <div className="text-white/70 text-sm">Crop Types</div>
//             </div>
//             <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
//               <div className="w-8 h-8 bg-blue-400 rounded-full mx-auto mb-2 flex items-center justify-center text-white font-bold">🌍</div>
//               <div className="text-2xl font-bold text-white">15+</div>
//               <div className="text-white/70 text-sm">Countries</div>
//             </div>
//             <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 text-center border border-white/20">
//               <div className="w-8 h-8 bg-purple-400 rounded-full mx-auto mb-2 flex items-center justify-center text-white font-bold">🏆</div>
...
//                 <div className="w-12 h-12 bg-green-400 rounded-xl mb-4 flex items-center justify-center text-2xl">🌱</div>
//                 <h3 className="text-xl font-bold text-white mb-3">Smart Farming</h3>
//                 <p className="text-white/70">
//                   AI-powered crop monitoring, precision agriculture, and automated farming solutions for maximum yield.
//                 </p>
//               </div>
//               <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
//                 <div className="w-12 h-12 bg-blue-400 rounded-xl mb-4 flex items-center justify-center text-2xl">💧</div>
//                 <h3 className="text-xl font-bold text-white mb-3">Water Management</h3>
//                 <p className="text-white/70">
//                   Efficient irrigation systems, soil moisture monitoring, and water conservation techniques.
//                 </p>
//               </div>
//               <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
//                 <div className="w-12 h-12 bg-yellow-400 rounded-xl mb-4 flex items-center justify-center text-2xl">🌾</div>
//                 <h3 className="text-xl font-bold text-white mb-3">Crop Analytics</h3>
//                 <p className="text-white/70">
//                   Real-time crop health analysis, yield prediction, and harvest optimization strategies.
//                 </p>
//               </div>
//             </div>
//           </div>
...
//                 Join thousands of farmers who are already using our smart agriculture solutions to increase yields and reduce costs.
//               </p>
//               <button className="group bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 text-white font-bold px-8 py-4 rounded-xl transition-all duration-300 hover:scale-105">
//                 Get Started Today
